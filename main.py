...
def handle_message(event):
    ...
    if text == '最新' or text == '最新情報':
        ...
        reply.make_quick_reply(event.reply_token, text=line_text_new_data)
        ...
        reply.make_quick_reply(event.reply_token, text=line_text_week_data)
    else:
        reply.make_quick_reply(event.reply_token, text="入力する言葉が違うよ！\n\n最新情報は\"最新\"\n一週間の情報は\"一週間\"\n\nと入力してね！\n\n詳しい感染状況はこちらのサイトから確認してね！\nhttps://www.mhlw.go.jp/stf/covid-19/kokunainohasseijoukyou.html\n")
